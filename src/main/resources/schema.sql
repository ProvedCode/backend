DROP TABLE talent CASCADE ;
DROP TABLE talent_description CASCADE ;
DROP TABLE talent_link CASCADE ;
DROP TABLE talent_contact CASCADE ;
DROP TABLE talent_attached_file CASCADE ;
DROP TABLE talent_skill CASCADE ;
